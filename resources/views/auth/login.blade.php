        ...
        <section class="flex flex-col items-center justify-center bg-background dark:bg-on-background px-margin-mobile md:px-margin-desktop py-12">
            <div class="w-full max-w-md space-y-8">
                ...
                <div class="flex flex-col items-center text-center">
                    ...
                    <h2 class="font-headline-md text-headline-md text-on-surface dark:text-inverse-on-surface">Masuk ke Akun Anda</h2>
                    <p class="text-on-surface-variant dark:text-outline-variant mt-2 font-body-md">Masukkan Email dan Password yang Terdaftar</p>
                </div>
                ...
                <form action="{{ route('login') }}" class="space-y-6" method="POST">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input class="w-full pl-10 pr-12 py-3 bg-surface-container-low dark:bg-surface-dim/10 border-2 border-transparent focus:border-primary dark:focus:border-secondary-container rounded-xl text-on-surface dark:text-on-primary-container placeholder:text-outline/50 transition-all outline-none" id="password" name="password" placeholder="••••••••••••" required type="password">
                    ...
                    <div class="flex items-center justify-between pt-1">
                        <div class="flex items-center">
                            <input class="w-5 h-5 rounded border-outline text-primary focus:ring-primary-container dark:bg-surface-dim/20 transition-all cursor-pointer" id="remember_me" name="remember" type="checkbox">
                            <label class="ml-2 text-sm font-semibold text-on-surface-variant dark:text-outline-variant cursor-pointer select-none" for="remember_me">Ingat Saya</label>
                        </div>
                        <a class="text-sm font-bold text-primary dark:text-secondary-container hover:underline decoration-2 underline-offset-4" href="{{ route('password.request') }}">
                            Lupa Password?
                        </a>
                    </div>
                    
                    <button class="w-full py-4 gradient-brand text-white font-bold text-body-lg rounded-xl shadow-lg shadow-primary/20 hover:shadow-primary/40 hover:scale-[1.02] active:scale-95 transition-all duration-200 flex items-center justify-center gap-2" type="submit">
                        Masuk
                ...
                <div class="text-center pt-4">
                    <p class="text-body-md text-on-surface-variant dark:text-outline-variant">
                        Belum memiliki akun? 
                        <a class="font-bold text-primary dark:text-secondary-container hover:underline decoration-2 underline-offset-4 ml-1" href="{{ route('register') }}">Register</a>
                    </p>
                </div>
