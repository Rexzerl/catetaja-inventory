        ...
        <section class="flex flex-col items-center justify-center bg-background dark:bg-on-background px-margin-mobile md:px-margin-desktop py-12">
            <div class="w-full max-w-md space-y-8">
                ...
                <div class="flex flex-col items-center text-center">
                    ...
                    <h2 class="font-headline-md text-headline-md text-on-surface dark:text-inverse-on-surface">Lupa Password?</h2>
                    <p class="text-on-surface-variant dark:text-outline-variant mt-2 font-body-md">Masukkan email terdaftar untuk menerima link reset.</p>
                </div>

                @if (session('status'))
                    <div class="bg-green-50 dark:bg-green-950/30 border border-green-200 dark:border-green-900/50 text-green-700 dark:text-green-400 p-4 rounded-xl text-sm font-medium">
                        {{ session('status') }}
                    </div>
                @endif
                ...
                <div class="text-center pt-4">
                    <p class="text-body-md text-on-surface-variant dark:text-outline-variant">
                        <a class="font-bold text-primary dark:text-secondary-container hover:underline decoration-2 underline-offset-4" href="{{ route('login') }}">&larr; Kembali ke Halaman Login</a>
                    </p>
                </div>
            </div>
        </section>
